...
export function ElasticSlider({
   ...
   return (
      <div ref={wrapperRef} data-slot="elastic-slider" className={cn("elastic-slider", className)}>
         <motion.div
            ref={trackRef}
            role="slider"
            tabIndex={0}
         ...
         >
            <div
               ...
               aria-hidden="true"
               className="elastic-slider__hashes"
            >
               {Array.from({ length: hashMarkCount }, (_, i) => (
                  <div
                     key={i}
                     className="elastic-slider__hash"
            ...
            <motion.div
               ...
               aria-hidden="true"
               className="elastic-slider__fill"
            ...
            <motion.div
               ...
               aria-hidden="true"
               className="elastic-slider__handle"
            ...
            <span
               ...
               aria-hidden="true"
               className="elastic-slider__label"
            >
               {label}
            </span>
